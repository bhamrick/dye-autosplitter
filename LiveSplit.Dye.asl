state("dyegame")
{
	int purplePigments	: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x16C;
	int bluePigments	: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x170;
	int greenPigments	: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x174;
	int redPigments		: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x178;
	float purpleBoss	: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x17C;
	float blueBoss		: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x180;
	float greenBoss		: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x184;
	float redBoss		: "mono.dll", 0x269758, 0, 0x3D0, 0x78, 0x38, 0x188;
